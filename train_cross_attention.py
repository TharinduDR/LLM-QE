#!/usr/bin/env python3
"""
Train NLLB-QE with Cross-Attention and Pairwise Contrastive Loss.
"""
...
# CHANGED: Import cross-attention model
from models.nllb_qe_cross_attention import NLLBQECrossAttention
...
def train(
    ...
    """Train with cross-attention model."""
    ...
    print(f"\n{'=' * 70}")
    print(f"Starting Training with Cross-Attention")
    print(f"{'=' * 70}")
    print(f"Architecture: Encoder + Cross-Attention")
...
def main():
    parser = argparse.ArgumentParser(description="Train NLLB-QE with Cross-Attention")
    ...
    # Training arguments
    parser.add_argument("--output_dir", type=str, default="./checkpoints/nllb_cross_attn")
    ...
    parser.add_argument("--run_name", type=str, default="nllb-cross-attn")
    ...
    if args.use_wandb:
        wandb.init(
            project="nllb-qe-cross-attention",
            name=args.run_name,
            config=vars(args)
        )
